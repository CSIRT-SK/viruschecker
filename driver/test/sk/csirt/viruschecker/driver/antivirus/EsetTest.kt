...
internal class EsetTest : CommandLineAntivirusTest() {
    override val mockFileScanOutputHealthy =
...
Command line: $SCAN_FILE /log-all

Scan started at:   Wed Nov 20 13:41:54 2019
name="$SCAN_FILE", result="is OK", action="", info=""
...
""".trimIndent()
    ...
    override val mockFileScanOutputInfected =
        """ECLS Command-line scanner, version 12.2.29.0, (C) 1992-2019 ESET, spol. s r.o.
Module loader, version 1018.1 (20190709), build 1054
Module perseus, version 1555 (20190911), build 2060
Module scanner, version 20102 (20190930), build 42937
...
name="$SCAN_FILE", result="Eicar test file", action="", info=""
...
""".trimIndent()
    ...
    override val mockArchiveFileScanOutputHealthy =
        """ECLS Command-line scanner, version 12.2.29.0, (C) 1992-2019 ESET, spol. s r.o.
Module loader, version 1018.1 (20190709), build 1054
Module perseus, version 1555 (20190911), build 2060
Module scanner, version 20102 (20190930), build 42937
...
name="$SCAN_FILE", result="is OK", action="", info=""
name="$SCAN_FILE » ZIP » go/bin/rsrc.exe", result="is OK", action="", info=""
name="$SCAN_FILE » ZIP » go/pkg/windows_amd64/github.com/kardianos/osext.a", result="is OK", action="", info=""
...
""".trimIndent()
    ...
    override val mockArchiveFileScanOutputInfected =
        """ECLS Command-line scanner, version 12.2.29.0, (C) 1992-2019 ESET, spol. s r.o.
Module loader, version 1018.1 (20190709), build 1054
Module perseus, version 1555 (20190911), build 2060
Module scanner, version 20102 (20190930), build 42937
