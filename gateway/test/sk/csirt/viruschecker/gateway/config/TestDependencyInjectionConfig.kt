...
@KtorExperimentalAPI
fun testGatewayDependencyInjectionModule(httpClientRequestHandler: MockRequestHandler = { respondOk() }) = module {
    single<ScanReportRepository> { KeyValueScanReportRepository(ConcurrentHashMap()) }
